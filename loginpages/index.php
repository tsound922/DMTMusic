...
<div class="container" id="colorstyle" align="center">
  <h3>Welcome to DMT Music</h3>
  <p><h4>This site is a place for all the music production lovers. You can communicate with other producers, find and upload your creations in this website </h4></p>
</div>
   <div id="footer"><h4>This site is built by Zhenyu Wang (Student ID:12110235), and this site is only use as the assignment of subject Digital Media Technology. <strong><label style="color:red">Please do not use it for commercial use.</label></div>
